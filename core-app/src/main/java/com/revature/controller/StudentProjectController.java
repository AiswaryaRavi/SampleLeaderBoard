...
public class StudentProjectController {
	...
	public List<StudentProject> getStudentProjectPercentageCalculation(@PathVariable("studentId") Integer studentId) {
		List<StudentProject> studentProjects = null;
		try {
			logger.info("Getting the student projects data...");
			studentProjects = studentProjectService.getStudentProjectPercentageCalculation(studentId);
			logger.info("student projects data retrieval success.");
		} catch (BusinessServiceException e) {
			logger.error(e.getMessage(), e);
			throw new InvalidInputException(e.getMessage(), e);
